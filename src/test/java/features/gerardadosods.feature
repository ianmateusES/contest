# language: pt
	Funcionalidade: Gerar Dados dos Encontros Universitarios.

		Eu como organizador do evento gostaria de gerar os dados em ods
		para os encontros universitarios
		
		Cenário: O organizador gera planilha para organizadores
	    ...
	    Cenário: O organizador gera planilha para revisores
	    ...
	    Cenário: O organizador gera planilha para os trabalhos
